...
describe("VersionManager.mustTriggerFullResync", () => {
  describe("forceResyncVersion is defined", () => {
    beforeEach(() => {
      sinon.stub(VersionManager, "forceResyncVersion").returns("2.0.0")
    })
    afterEach(() => {
      VersionManager.forceResyncVersion.restore()
    })
  ...
  describe("forceResyncVersion is undefined", () => {
    beforeEach(() => {
      sinon.stub(VersionManager, "forceResyncVersion").returns(undefined)
    })
    afterEach(() => {
      VersionManager.forceResyncVersion.restore()
    })
...
describe("VersionManager.mustShowUpdateNotification", () => {
  ...
  describe("installations details refer to an update", () => {
    beforeEach(() => {
      sinon.stub(VersionManager, "getCurrentVersion").returns("2.2.2")
    })
    afterEach(() => {
